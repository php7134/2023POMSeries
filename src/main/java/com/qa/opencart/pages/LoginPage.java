...
public class LoginPage {
	...
	public String getLoginPageTitle() {
		return eleUtil.waitForTitleIsAndCpature(AppConstants.LOGIN_PAGE_TITLE_VALUE, AppConstants.SHORT_DEFAULT_WAIT);
	}

	@Step("getting login page url")
	public String getLoginPageURL() {
		return eleUtil.waitForURLContainsAndCpature(AppConstants.LOGIN_PAGE_URL_FRACTION_VALUE,
	...
	public AccountsPage doLogin(String userName, String pwd) {
		System.out.println("correct cred are : " + userName + ":" + pwd);
