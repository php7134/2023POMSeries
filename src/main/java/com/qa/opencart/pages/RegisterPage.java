...
public class RegisterPage {
...

	{
		...
		String userRegSucessMesg = eleUtil.waitForElementVisible(userRegSuccMessg, AppConstants.MEDIUM_DEFAULT_WAIT)
				.getText();

		System.out.println(userRegSucessMesg);
